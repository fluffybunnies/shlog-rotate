...
By default, many module's default installation will automatically rotate their access and error logs (e.g. nginx, mysql, php, etc). You can check via ```ls /etc/logrotate.d```
