...
By default, many module's default installation will automatically rotate their logs using unix's logrotate (e.g. nginx, mysql, php, etc). You can check via ```ls /etc/logrotate.d```
